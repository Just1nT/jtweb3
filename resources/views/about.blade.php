...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="about Justin Tannenbaum"/>
        <!-- Styles -->
          ...
          <div class="flex flex-wrap mb-4">
            ...
            <div class="lg:w-1/2">
              ...
              <p class="font-display text-black text-md ml-6 mr-4 mt-12">
                Designed and developed by Justin Tannenbaum with <a href="https://tailwindcss.com/" class="underline text-blue-700" target="_blank">Tailwind CSS</a>, the <a href="https://laravel.com/" target="_blank" class="underline text-blue-700">Laravel Framework</a> and <a href="https://vuejs.org/" target="_blank" class="underline text-blue-700">Vue.js</a>. View the source for this project <a href="https://github.com/Just1nT/jtweb3#jtweb3" target="_blank" class="underline text-blue-700">here</a>.
              </p>
            </div>
          </div>
        </div>
